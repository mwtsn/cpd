...
class CPD_Taxonomy_Development_Category {
	...
	public function set_text_domain( $text_domain ) {
		...
		if(
			...
			isset( $mkdo_aspire_visible_taxonomies['development-category']['use-tags'] ) &&
			$mkdo_aspire_visible_taxonomies['development-category']['use-tags'] == 'true'
		) {
			$hirachical = false;
		}
	...
	public function register_taxonomy() {
		...
		if(
			(
				! isset( $mkdo_aspire_visible_taxonomies['development-category'] ) ||
				! isset( $mkdo_aspire_visible_taxonomies['development-category']['show-to-supervisors'] )
			) &&
		...
		if(
			(
				! isset( $mkdo_aspire_visible_taxonomies['development-category'] ) ||
				! isset( $mkdo_aspire_visible_taxonomies['development-category']['show-to-particpants'] )
			) &&
